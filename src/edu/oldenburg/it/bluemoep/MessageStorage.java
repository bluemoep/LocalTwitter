...
public class MessageStorage {
	...
	public List<Message> getMessages(double north, double east, double south, double west) {
		...
		SortedMap<Integer, SortedMap<Integer, List<Message>>> subset = storage.subMap(ssouth, snorth);
		for(SortedMap<Integer, List<Message>> storage2 : subset.values()) {
			SortedMap<Integer, List<Message>> subset2 = storage2.subMap(swest, seast);
